...
-- Tabla de cierres contables conectada con usuarios
CREATE TABLE cierres_contables (
    ...
    pdf_path TEXT,
    usuario_id INTEGER REFERENCES usuarios(id)  -- Usuario que realizó el cierre
);
...
CREATE INDEX idx_detalles_factura_factura_id ON detalles_factura(factura_id);
CREATE INDEX idx_pagos_factura_factura_id ON pagos_facturas(factura_id);
